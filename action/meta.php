...
class action_plugin_ckgedit_meta extends DokuWiki_Action_Plugin {
	...
	function insertFormElement(&$event, /** @noinspection PhpUnusedParameterInspection */
                               $param) {
	...
	function preprocess(&$event, /** @noinspection PhpUnusedParameterInspection */
                        $param) {
		$act = $event->data;
...
// msg('REL='. DOKU_REL);
	...
	function file_type(/** @noinspection PhpUnusedParameterInspection */
        &$event, $param) {
	...
	function loadScript(/** @noinspection PhpUnusedParameterInspection */
        &$event) {
		echo <<<SCRIPT
...
SCRIPT;
     ...
     * @param $event
     */
	function setupDWEdit(/** @noinspection PhpUnusedParameterInspection */
        &$event) {
		global $ACT;
