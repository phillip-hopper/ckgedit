...
CKEDITOR_REPLACE;
        ...
        <form id="dw__editform" method="post" action="<?php echo script()?>"
            ...
            <textarea name="wikitext" id="wiki__text" <?php echo $ro?> cols="80" rows="10" class="edit"
                      tabindex="1"><?php echo "\n" . $this->xhtml?></textarea>
            ...
            <div id="wiki__editbar">
                ...
                <?php if($wr) { ?>
                    <div class="editButtons">
                        ...
                        <div id="backup_msg" class="backup_msg" style=" display:none;">
                            <table>
                                <tr>
                                    <td class="backup_msg_td">
                                        <div id="backup_msg_area" class="backup_msg_area"></div>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <td align="right">
                                        <a href="javascript:hide_backup_msg();void(0);" class="backup_msg_close">[ close
                                            ]</a>&nbsp;&nbsp;&nbsp;
                            </table>
                        ...
                        <label class="nowrap" for="complex_tables">
                            <input type="checkbox" name="complex_tables" value="complex_tables" id="complex_tables"
                                /><span id='complex_tables_label'> <?php echo $this->getLang('complex_tables'); ?> (<a
                                    href="https://www.dokuwiki.org/plugin:fckglite#table_handling"
                                    target='_blank'><?php echo $this->getLang('whats_this') ?></a>)</span></label>
                ...
                <?php if($wr) { ?>
                    <div class="summary">
                        ...
                        <input type="text" class="edit" name="summary" id="edit__summary" size="50"
                               value="<?php echo formText($SUM) ?>" tabindex="2"/>
                        <label class="nowrap" for="minoredit"><input type="checkbox" id="minoredit" name="minor"
                                                                     value="1" tabindex="3"/>
                            <span><?php echo $this->getLang('minor_changes') ?></span></label>
                    </div>
                <?php }?>
            </div>
        </form>
        ...
        <script type="text/javascript">
            ...
            var ckgedit_xcl_styles = (ckgedit_xcl_fonts + ckgedit_xcl_colors == 2);
    ...
    function _render_xhtml($text) {
        ...
        if($smiley_as_text) {
            ...
            $Smilies = array(
                '8-)' => 'aSMILEY_1', '8-O' => 'aSMILEY_2', ':-(' => 'aSMILEY_3', ':-)' => 'aSMILEY_4',
        ...
        p_get_instructions("=== header ==="); // loads DOKU_PLUGINS array --M.T. Dec 22 2009
        global $multi_block;
    ...
    function write_debug(/** @noinspection PhpUnusedParameterInspection */
        $what) {
